...
export const projectType = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'string',
      description: 'One-line recruiter hook shown under the title on homepage (e.g. "Top 20% finish among 3,000+ competitors")',
    ...
    defineField({
      ...
      type: 'array',
      description: 'Short technology names shown as tags on homepage (e.g. Python, XGBoost, FastAPI)',
      of: [{ type: 'string' }],
      options: { layout: 'tags' },
      group: 'details',
    }),
